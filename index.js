...
var translateController_1 = __webpack_require__(12);
...
var express_1 = tslib_1.__importDefault(__webpack_require__(7));
var HttpServer_1 = __webpack_require__(8);
var containerDI_1 = __webpack_require__(3);
function start() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            server = new HttpServer_1.HttpServer(express_1["default"], containerDI_1.myContainer);
...
var errorHandlingMiddleware_1 = __webpack_require__(9);
// import { mongoURI, port } from './../../config/default.json'
var interfaces_1 = __webpack_require__(1);
var inversify_express_utils_1 = __webpack_require__(2);
var containerDI_1 = __webpack_require__(3);
var cors_1 = tslib_1.__importDefault(__webpack_require__(17));
var HttpServer = /*#__PURE__*/function () {
  function HttpServer(framework, containerDI) {
    var _this = this;
...
var ApiError_1 = __webpack_require__(10);
  ...
  _createClass(TranslateController, [{
    ...
    value: function () {
      var _translate = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(request, response) {
        var _request$query, language, translatedLanguage, word, browser, data;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
...
TranslateController = tslib_1.__decorate([(0, inversify_express_utils_1.controller)("/api/translate"), tslib_1.__param(0, (0, inversify_1.inject)(interfaces_1.TYPES.Browser)), tslib_1.__metadata("design:paramtypes", [Object])], TranslateController);
...
if (process.env.AWS_LAMBDA_FUNCTION_VERSION) {
  chrome = __webpack_require__(14);
  puppeteer = __webpack_require__(15);
} else {
  puppeteer = __webpack_require__(16);
}
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _rendererOptions = _args4.length > 1 && _args4[1] !== undefined ? _args4[1] : {};
                // if (browserURL) {
              ...
              case 9:
                return _context4.abrupt("return", puppeteer.launch(options));
              case 10:
              case "end":
